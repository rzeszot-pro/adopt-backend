...
describe Api::Auth::SignUp::Create do
  it "creates user on sign up" do
    UserToken.stub_token("fake-token") do
      response = AppClient.exec(Api::Auth::SignUp::Create, user: valid_params)
  ...
  it "returns error for invalid params" do
    ...
    response = AppClient.exec(Api::Auth::SignUp::Create, user: invalid_params)
